...
Tag the current main with current version and push to start the release workflow. This will build the tarball for CRAN and create a pre-release with the tarball and a generated `cran-comments-<tag>.md` file attached.
```
git tag v1.0.0
git push origin v1.0.0
```

Download the tarball and `cran-comments-<tag>.md` from the pre-release. Review the comments file and decide if anything must be addressed before submission. Add any extra information (e.g. "This is a new submission") and ensure the file is understandable.
